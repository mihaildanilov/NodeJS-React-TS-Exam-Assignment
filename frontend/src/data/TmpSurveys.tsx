interface TmpSurveysQuestionOption {
	uuid: string;
	text: string;
}

interface TmpSurveysQuestion {
	id: number;
	type: 'text' | 'checkbox' | 'select' | 'radio' | 'textarea';
	question: string;
	description: string | null;
	data?: { options: TmpSurveysQuestionOption[] | undefined } | undefined;
}

export interface TmpSurveysProps {
	id: number;
	image_url: string;
	title: string;
	slug: string;
	...
	updated_at: string;
	expire_date: string;
	questions: TmpSurveysQuestion[];
}

export const TmpSurveys: TmpSurveysProps[] = [
	{
		id: 1,
